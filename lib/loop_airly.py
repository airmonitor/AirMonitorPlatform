...
def loop_airly(czas):
    ...
    try:
        ...
        merged_airly_ids_lat_long = list(
            zip(result_airly_latitude, result_airly_longitude)
        )
            ...
            try:
                ...
                if (returned_value_from_custom_sensors_pm10_airly != 0) or (
                    ...
                    map_icon_colour = map_pins(
                        pm10_points_percentage_airly, pm25_points_percentage_airly
                    )
                    ...
                    html_airly = htmlmin.minify(
                        html_airly, remove_comments=True, remove_empty_space=True
                    )
